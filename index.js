const Perguntas = [
    ...
    {
      pergunta: "O que o método 'charAt()' retorna se o índice fornecido estiver fora dos limites da string?",
      respostas: [
        "null",
        "undefined",
        "Um string vazio ('')"
    ...
    {
      pergunta: "Qual é a maneira correta de comentar várias linhas de código em JavaScript?",
      respostas: [
